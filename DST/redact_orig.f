c     from Urban notebook: O16/redact.f (2004-10-28)
c
      subroutine redact
      common/bc/b(500),c(1000)/nw/nw,nwc,nk,nkon,nkan,p0(5)
      data p0/3.25,3.34,3.19,3.3,3.31/
      open(1,file='c:\dst\kis57.dst',form='binary')
      open(2,file='c:\dst\dub57.dst',form='binary')
      open(3,file='c:\dst\kis61.dst',form='binary')
      open(4,file='c:\dst\kis65.dst',form='binary')
      open(5,file='c:\dst\dub61.dst',form='binary')
    1 ik=nkan
...
c     popravki na glubinnye ugly fragmentov s uchetom ih zaryada,
c     dliny izmerennogo treka i nomera zalivki
